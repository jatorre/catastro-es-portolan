...
CRS = "EPSG:25830"
BUCKET_URL = "https://storage.googleapis.com/catastro-es-portolan"
STAGING = Path("/tmp/cat_catalog"); CONV = Path("/tmp/cat_conv/_norm")
VEC_SRC = Path("/tmp/catout"); TAB_SRC = Path("/tmp/comu_conv/tab"); COG_SRC = Path("/tmp/comu_conv/cog")
MAN_VEC = "/tmp/cat_manifest_vector.json"; MAN_TAB = "/tmp/cat_manifest_tab_none.json"
MAN_RAS = "/tmp/cat_manifest_ras_none.json"
IRC_PREFIX = "sdi"; DUCKDB = "duckdb"
GEOM_EXT = ga.wkb().with_crs(CRS)
PROVIDER = "Dirección General del Catastro"; LICENSE = "Catastro INSPIRE (datos abiertos)"
COLLECTION = "catastro-es"
